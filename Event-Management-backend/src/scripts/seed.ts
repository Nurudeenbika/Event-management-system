...
const seedData = async () => {
  try {
    ...
    await mongoose.connect(
      process.env.MONGODB_URI || "mongodb://localhost:27017/event-booking"
    );
    ...
    const events = await Event.create([
      {
        ...
        description:
          "Annual technology conference featuring latest trends in AI, ML, and Web Development.",
        category: "conference",
        location: "Lagos",
      ...
      },
      {
        ...
        description:
          "Hands-on workshop covering modern JavaScript frameworks and best practices.",
        category: "workshop",
        location: "Abuja",
        venue: "TechHub Abuja",
      ...
      },
      {
        ...
        description:
          "Intensive 3-day bootcamp on React Native mobile app development.",
        category: "workshop",
        location: "Lagos",
      ...
      },
      {
        ...
        description:
          "Annual startup pitch competition for early-stage companies.",
        category: "networking",
        location: "Lagos",
      ...
      },
      {
        ...
        description:
          "Explore the future of blockchain technology and cryptocurrencies.",
        category: "seminar",
        location: "Abuja",
      ...
      },
      {
        ...
        description:
          "Discuss the impact of AI on healthcare and medical research.",
        category: "conference",
        location: "Lagos",
        venue: "Radisson Blu",
      ...
      },
      {
        ...
        description:
          "Explore the latest trends in cloud computing and its applications.",
        category: "seminar",
        location: "Enugu",
